    ...
    <div id="leftsidebar" class="sidebar">
        <div class="menu">
            <ul class="list">
                ...
                <li class="sm_menu_btm active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-copy"></i><span>Sample Pages</span> <span class="badge badge-primary float-right">12</span></a>
                    <ul class="ml-menu">
                        <li class="acctive"><a href="blank.html">Blank Page</a></li>
