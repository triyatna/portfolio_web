...
<aside id="minileftbar" class="minileftbar">
    <ul class="menu_list">
        <li>
            ...
            <a class="navbar-brand" href="index.html"><img src="assets/images/logo.svg" alt="TY CORP"></a>
        </li>
        ...
        <li><a href="inbox.php" title="Inbox"><i class="zmdi zmdi-email"></i></a></li>
        ...
        <li class="power">
            ...
            <a href="auth/logout.php" class="mega-menu"><i class="zmdi zmdi-power"></i></a>
        </li>
    </ul>    
</aside>
            ...
            <div class="card">
                ...
                <div class="body">
                    <ul class="list-unstyled menu">
                        ...
                        <li><a href="./blog.php"><i class="zmdi zmdi-blogger"></i><span>Blog</span></a></li>
                ...
                <div class="body">
                    <ul class="notification list-unstyled">
                        ...
                        <li>
                            ...
                            <strong>TY CORP v1.0.0 is available</strong>
